...
const Logo = (textStyles) => {
  return (
    <View className="flex-row pt-6 justify-center items-center">
        ...
        <Text className={`font-psemibold text-4xl text-[#FF8585] ${textStyles}`}>r</Text>
        <Text className={`font-psemibold text-4xl text-[#FFAD7E] ${textStyles}`}>u</Text>
        <Text className={`font-psemibold text-4xl text-[#B5977F] ${textStyles}`}>i</Text>
        <Text className={`font-psemibold text-4xl text-[#FCEF00] ${textStyles}`}>t</Text>
        ...
        <Text className={`font-psemibold text-4xl text-[#D899DF] ${textStyles}`}>a</Text>
    </View>
  )
}
